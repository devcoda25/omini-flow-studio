...
class ContentView {
    ...
    markDirty() {
        let andParent = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false;
    ...
    replaceChildren(from, to) {
        let children = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : noChildren;
        this.markDirty();
    ...
    childCursor() {
        let pos = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : this.length;
...
function getInclusive(spec) {
    let block = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
...
function addRange(from, to, ranges) {
    let margin = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 0;
...
class ContentBuilder {
    ...
    flushBuffer() {
        let active = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : this.bufferMarks;
...
class DocView extends ContentView {
    ...
    updateSelection() {
        let mustRead = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false, fromPointer = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
...
function groupAt(state, pos) {
    let bias = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 1;
...
function posAtCoords(view, coords, precise) {
    let bias = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : -1;
    var _a, _b;
...
function applyDOMChangeInner(view, change, newSel) {
    let lastKey = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : -1;
...
class HeightMapBlock extends HeightMap {
    ...
    updateHeight(oracle) {
        let offset = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, _force = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false, measured = arguments.length > 3 ? arguments[3] : void 0;
...
class HeightMapText extends HeightMapBlock {
    ...
    updateHeight(oracle) {
        let offset = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, force = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false, measured = arguments.length > 3 ? arguments[3] : void 0;
        if (measured && measured.from <= offset && measured.more) this.setHeight(measured.heights[measured.index++]);
...
class ViewState {
    ...
    update(update) {
        let scrollTarget = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null;
    ...
    viewportIsAppropriate(param) {
        let { from, to } = param, bias = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
...
class DOMObserver {
    ...
    flush() {
        let readSelection = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true;
...
class EditContextManager {
    ...
    toEditorPos(contextPos) {
        let clipLen = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.to - this.from;
        ...
        this.handlers.textformatupdate = (e)=>{
            ...
            for (let format of e.getTextFormats()){
                ...
                if (lineStyle != "None" && thickness != "None") {
                    ...
                    if (from < to) {
                        let style = "text-decoration: underline ".concat(lineStyle == "Dashed" ? "dashed " : lineStyle == "Squiggle" ? "wavy " : "").concat(thickness == "Thin" ? 1 : 2, "px");
...
*/ class EditorView {
    ...
    */ setState(newState) {
    ...
    @internal
    */ measure() {
        let flush = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true;
    ...
    */ moveToLineBoundary(start, forward) {
        let includeWrap = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
    ...
    */ posAtDOM(node) {
    ...
    posAtCoords(coords) {
        let precise = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
        this.readMeasured();
    ...
    */ coordsAtPos(pos) {
        let side = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1;
        this.readMeasured();
    ...
    */ static theme(spec, options) {
        ...
        let result = [
            theme.of(prefix),
            styleModule.of(buildTheme(".".concat(prefix), spec))
        ];
...
function buildKeymap(bindings) {
    let platform = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : currentPlatform;
...
function runHandlers(map, event, view, scope) {
    ...
    if (scopeObj) {
        ...
        !(browser.mac && event.altKey && !event.ctrlKey) && (baseName = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$w3c$2d$keyname$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["base"][event.keyCode]) && baseName != name) {
...
function rectanglesForRange(view, className, range) {
    ...
    function pieces(param) {
        let { top, bottom, horizontal } = param;
        let pieces = [];
...
*/ config = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    return [
