...
*/ class Text {
    ...
    */ slice(from) {
        let to = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.length;
        [from, to] = clip(this, from, to);
        let parts = [];
    ...
    */ iter() {
        let dir = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 1;
...
class TextLeaf extends Text {
    ...
    sliceString(from) {
        let to = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.length, lineSep = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "\n";
        [from, to] = clip(this, from, to);
        let result = "";
...
class TextNode extends Text {
    ...
    static from(children) {
        let length = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : children.reduce((l, ch)=>l + ch.length + 1, -1);
        let lines = 0;
...
function appendText(text, target) {
    let from = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0, to = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 1e9;
...
class RawTextCursor {
    ...
    next() {
        let skip = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0;
        if (skip < 0) {
...
*/ class ChangeDesc {
    ...
    */ iterGaps(f) {
    ...
    reported separately.
    */ iterChangedRanges(f) {
        let individual = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
    ...
    */ mapDesc(other) {
        let before = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
        return other.empty ? this : mapSet(this, other, before);
    }
    mapPos(pos) {
        let assoc = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : -1, mode = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : MapMode.Simple;
        let posA = 0, posB = 0;
        for(let i = 0; i < this.sections.length;){
    ...
    returned.
    */ touchesRange(from) {
        let to = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : from;
...
function addSection(sections, len, ins) {
    let forceJoin = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : false;
...
function mapSet(setA, setB, before) {
    let mkSet = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : false;
...
function composeSets(setA, setB) {
    let mkSet = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
    let sections = [];
...
*/ class SelectionRange {
    ...
    */ eq(other) {
        let includeAssoc = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
...
*/ class EditorSelection {
    ...
    */ addRange(range) {
        let main = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
    ...
    */ replaceRange(range) {
        let which = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.mainIndex;
    ...
    */ static single(anchor) {
        let head = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : anchor;
    ...
    */ static create(ranges) {
        let mainIndex = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
    ...
    */ static cursor(pos) {
        let assoc = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, bidiLevel = arguments.length > 2 ? arguments[2] : void 0, goalColumn = arguments.length > 3 ? arguments[3] : void 0;
...
function flatten(extension, compartments, newCompartments) {
    ...
    function inner(ext, prec) {
        ...
        if (Array.isArray(ext)) {
            ...
            if (!content) throw new Error("Unrecognized extension value in extension set (".concat(ext, "). This sometimes happens because multiple instances of @codemirror/state are loaded, breaking instanceof checks."));
            inner(content, prec);
        }
    }
...
*/ class StateEffect {
    ...
    */ is(type) {
    ...
    removed.
    */ static define() {
        let spec = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
...
*/ class EditorState {
    field(field) {
        let require = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
    ...
    */ sliceDoc() {
        let from = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, to = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.doc.length;
    ...
    */ toJSON(fields) {
    ...
    third argument.
    */ static fromJSON(json) {
        let config = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, fields = arguments.length > 2 ? arguments[2] : void 0;
    ...
    */ get readOnly() {
    ...
    literal dollar sign.
    */ phrase(phrase) {
        for(var _len = arguments.length, insert = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++){
            insert[_key - 1] = arguments[_key];
        }
...
*/ function combineConfig(configs, defaults) {
    let combine = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
    let result = {};
...
class Chunk {
    ...
    findIndex(pos, side, end) {
        let startAt = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 0;
...
*/ class RangeSet {
    ...
    */ iter() {
        let from = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0;
    ...
    */ minPointSize = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : -1;
    ...
    */ static eq(oldSets, newSets) {
        let from = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0, to = arguments.length > 3 ? arguments[3] : void 0;
...
class LayerCursor {
    ...
    goto(pos) {
        let side = arguments.length > 1 && arguments[1] !== void 0 /* C.Far */  ? arguments[1] : -1000000000;
...
class HeapCursor {
    static from(sets) {
        let skip = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null, minPoint = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : -1;
        let heap = [];
...
*/ function countColumn(string, tabSize) {
    let to = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : string.length;
    let n = 0;
...
//# sourceMappingURL=node_modules_%40codemirror_state_dist_index_9b015ec1.js.map