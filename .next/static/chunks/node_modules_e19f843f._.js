...
;
;
const MiniMapNode = (param)=>{
    let { id, x, y, width, height, style, color, strokeColor, strokeWidth, className, borderRadius, shapeRendering, onClick, selected } = param;
...
function MiniMapNodes(param) {
    let { nodeStrokeColor = 'transparent', nodeColor = '#e2e2e2', nodeClassName = '', nodeBorderRadius = 5, nodeStrokeWidth = 2, // We need to rename the prop to be `CapitalCase` so that JSX will render it as
    // a component properly.
    nodeComponent: NodeComponent = MiniMapNode$1, onClick } = param;
...
function MiniMap(param) {
    let { style, className, nodeStrokeColor = 'transparent', nodeColor = '#e2e2e2', nodeClassName = '', nodeBorderRadius = 5, nodeStrokeWidth = 2, // We need to rename the prop to be `CapitalCase` so that JSX will render it as
    // a component properly.
    nodeComponent, maskColor = 'rgb(240, 240, 240, 0.6)', maskStrokeColor = 'none', maskStrokeWidth = 1, position = 'bottom-right', onClick, onNodeClick, pannable = false, zoomable = false, ariaLabel = 'React Flow mini map', inversePan = false, zoomStep = 10, offsetScale = 5 } = param;
    const store = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reactflow$2f$core$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStoreApi"])();
...
"[project]/node_modules/@reactflow/node-resizer/dist/esm/index.mjs [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s({
    "NodeResizeControl": ()=>ResizeControl$1,
...
function getDirection(param) {
    let { width, prevWidth, height, prevHeight, invertX, invertY } = param;
...
function ResizeControl(param) {
    let { nodeId, position, variant = ResizeControlVariant.Handle, className, style = {}, children, color, minWidth = 10, minHeight = 10, maxWidth = Number.MAX_VALUE, maxHeight = Number.MAX_VALUE, keepAspectRatio = false, shouldResize, onResizeStart, onResize, onResizeEnd } = param;
    const contextNodeId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reactflow$2f$core$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNodeId"])();
    ...
    const startValues = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(initStartValues);
    const prevValues = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(initPrevValues);
    const getPointerPosition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reactflow$2f$core$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGetPointerPosition"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ResizeControl.useEffect": ()=>{
            ...
            const selection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$selection$2f$src$2f$select$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__select$3e$__["select"])(resizeControlRef.current);
            ...
            const dragHandler = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$drag$2f$src$2f$drag$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__drag$3e$__["drag"])().on('start', {
                "ResizeControl.useEffect.dragHandler": (event)=>{
                    const node = store.getState().nodeInternals.get(id);
                    const { xSnapped, ySnapped } = getPointerPosition(event);
                    var _node_width, _node_height, _node_position_x, _node_position_y;
                    prevValues.current = {
                        width: (_node_width = node === null || node === void 0 ? void 0 : node.width) !== null && _node_width !== void 0 ? _node_width : 0,
                        height: (_node_height = node === null || node === void 0 ? void 0 : node.height) !== null && _node_height !== void 0 ? _node_height : 0,
                        x: (_node_position_x = node === null || node === void 0 ? void 0 : node.position.x) !== null && _node_position_x !== void 0 ? _node_position_x : 0,
                        y: (_node_position_y = node === null || node === void 0 ? void 0 : node.position.y) !== null && _node_position_y !== void 0 ? _node_position_y : 0
                    };
                    startValues.current = {
                        ...prevValues.current,
                        pointerX: xSnapped,
            ...
            }["ResizeControl.useEffect.dragHandler"]).on('drag', {
                "ResizeControl.useEffect.dragHandler": (event)=>{
                    ...
                    if (node) {
                        ...
                        let width = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reactflow$2f$core$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clamp"])(startWidth + (invertX ? -distX : distX), minWidth, maxWidth);
                        let height = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reactflow$2f$core$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clamp"])(startHeight + (invertY ? -distY : distY), minHeight, maxHeight);
                        if (keepAspectRatio) {
            ...
            }["ResizeControl.useEffect.dragHandler"]).on('end', {
                "ResizeControl.useEffect.dragHandler": (event)=>{
                    const dimensionChange = {
                        id: id,
                        type: 'dimensions',
                    ...
                    onResizeEnd === null || onResizeEnd === void 0 ? void 0 : onResizeEnd(event, {
                        ...prevValues.current
                    });
            ...
            }["ResizeControl.useEffect.dragHandler"]);
...
var ResizeControl$1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["memo"])(ResizeControl);
...
function NodeResizer(param) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Fragment, null, lineControls.map((c)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement(ResizeControl$1, {
            key: c,
        ...
        })), handleControls.map((c)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement(ResizeControl$1, {
            key: c,
...
"[project]/node_modules/zundo/dist/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function findClusterBreak(str, pos) {
    let forward = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true, includeExtending = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : true;
...
"[project]/node_modules/@uiw/react-codemirror/esm/timeoutLatch.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$uiw$2f$react$2d$codemirror$2f$esm$2f$timeoutLatch$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@uiw/react-codemirror/esm/timeoutLatch.js [app-client] (ecmascript)");
;
;
;
;
;
;
var ExternalChange = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Annotation"].define();
...
function useCodeMirror(props) {
    ...
    var typingLatch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "useCodeMirror.useState": ()=>({
                current: null
            })
    }["useCodeMirror.useState"])[0];
    var pendingUpdate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "useCodeMirror.useState": ()=>({
                current: null
            })
    }["useCodeMirror.useState"])[0];
    ...
    var updateListener = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorView"].updateListener.of((vu)=>{
        ...
        !vu.transactions.some((tr)=>tr.annotation(ExternalChange))) {
            if (typingLatch.current) {
                ...
                typingLatch.current = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$uiw$2f$react$2d$codemirror$2f$esm$2f$timeoutLatch$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TimeoutLatch"](()=>{
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$uiw$2f$react$2d$codemirror$2f$esm$2f$timeoutLatch$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getScheduler"])().add(typingLatch.current);
            }
...
//# sourceMappingURL=node_modules_e19f843f._.js.map