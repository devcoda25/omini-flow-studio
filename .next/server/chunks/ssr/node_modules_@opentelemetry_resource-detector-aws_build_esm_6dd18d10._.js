...
var AwsBeanstalkDetectorSync = function() {
    ...
    AwsBeanstalkDetectorSync.prototype.detect = function(config) {
        var _this = this;
        var attributes = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$opentelemetry$2f$api$2f$build$2f$esm$2f$context$2d$api$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["context"].with((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$opentelemetry$2f$core$2f$build$2f$esm$2f$trace$2f$suppress$2d$tracing$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["suppressTracing"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$opentelemetry$2f$api$2f$build$2f$esm$2f$context$2d$api$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["context"].active()), function() {
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_b) {
                switch(_b.label){
                    ...
                    case 3:
                        e_1 = _b.sent();
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$opentelemetry$2f$api$2f$build$2f$esm$2f$diag$2d$api$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["diag"].debug("AwsBeanstalkDetectorSync failed: " + e_1.message);
                        return [
                            2 /*return*/ ,
                            {}
                        ];
    ...
    AwsBeanstalkDetectorSync.readFileAsync = __TURBOPACK__imported__module__$5b$externals$5d2f$util__$5b$external$5d$__$28$util$2c$__cjs$29$__["promisify"](__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["readFile"]);
    AwsBeanstalkDetectorSync.fileAccessAsync = __TURBOPACK__imported__module__$5b$externals$5d2f$util__$5b$external$5d$__$28$util$2c$__cjs$29$__["promisify"](__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["access"]);
            ...
            return __generator(this, function(_a) {
                return [
                    ...
                    new Promise(function(resolve, reject) {
                        ...
                        var req = __TURBOPACK__imported__module__$5b$externals$5d2f$http__$5b$external$5d$__$28$http$2c$__cjs$29$__["request"](options, function(res) {
 ...
 */ var AwsEcsDetectorSync = function() {
                ...
                switch(_f.label){
                    case 0:
                        if (!process.env.ECS_CONTAINER_METADATA_URI_V4 && !process.env.ECS_CONTAINER_METADATA_URI) {
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$opentelemetry$2f$api$2f$build$2f$esm$2f$diag$2d$api$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["diag"].debug('AwsEcsDetector failed: Process is not on ECS');
                            return [
                                2 /*return*/ ,
                                {}
                            ];
     ...
     */ AwsEcsDetectorSync._getContainerIdAndHostnameResource = function() {
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_b) {
                switch(_b.label){
                    case 0:
                        hostName = __TURBOPACK__imported__module__$5b$externals$5d2f$os__$5b$external$5d$__$28$os$2c$__cjs$29$__["hostname"]();
                        containerId = '';
                        _b.label = 1;
                    case 1:
                        _b.trys.push([
                    ...
                    case 3:
                        e_1 = _b.sent();
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$opentelemetry$2f$api$2f$build$2f$esm$2f$diag$2d$api$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["diag"].debug('AwsEcsDetector failed to read container ID', e_1);
                        return [
                            3 /*break*/ ,
                            4
                        ];
    ...
    AwsEcsDetectorSync._getUrlAsJson = function(url) {
        return new Promise(function(resolve, reject) {
            var request = __TURBOPACK__imported__module__$5b$externals$5d2f$http__$5b$external$5d$__$28$http$2c$__cjs$29$__["get"](url, function(response) {
    ...
    AwsEcsDetectorSync.readFileAsync = __TURBOPACK__imported__module__$5b$externals$5d2f$util__$5b$external$5d$__$28$util$2c$__cjs$29$__["promisify"](__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["readFile"]);
 ...
 */ var AwsEksDetectorSync = function() {
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_b) {
                switch(_b.label){
                    ...
                    case 6:
                        e_1 = _b.sent();
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$opentelemetry$2f$api$2f$build$2f$esm$2f$diag$2d$api$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["diag"].debug('Process is not running on K8S', e_1);
                        return [
                            2 /*return*/ ,
                            {}
                        ];
                ...
                switch(_c.label){
                    ...
                    case 2:
                        ...
                        try {
                            ...
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$opentelemetry$2f$api$2f$build$2f$esm$2f$diag$2d$api$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["diag"].debug('Cannot get cluster name on EKS', e);
                        }
                        return [
                            2 /*return*/ ,
                            ''
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
                switch(_a.label){
                    ...
                    case 2:
                        e_2 = _a.sent();
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$opentelemetry$2f$api$2f$build$2f$esm$2f$diag$2d$api$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["diag"].debug('Unable to read Kubernetes client token.', e_2);
                        return [
                            3 /*break*/ ,
                            3
                        ];
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
                switch(_a.label){
                    ...
                    case 2:
                        e_3 = _a.sent();
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$opentelemetry$2f$api$2f$build$2f$esm$2f$diag$2d$api$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["diag"].debug("AwsEksDetector failed to read container ID: " + e_3.message);
                        return [
                            3 /*break*/ ,
                            3
                        ];
                    ...
                    case 0:
                        return [
                            ...
                            new Promise(function(resolve, reject) {
                                ...
                                var req = __TURBOPACK__imported__module__$5b$externals$5d2f$https__$5b$external$5d$__$28$https$2c$__cjs$29$__["request"](options, function(res) {
                                    clearTimeout(timeoutId);
                                    var statusCode = res.statusCode;
    ...
    AwsEksDetectorSync.readFileAsync = __TURBOPACK__imported__module__$5b$externals$5d2f$util__$5b$external$5d$__$28$util$2c$__cjs$29$__["promisify"](__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["readFile"]);
    AwsEksDetectorSync.fileAccessAsync = __TURBOPACK__imported__module__$5b$externals$5d2f$util__$5b$external$5d$__$28$util$2c$__cjs$29$__["promisify"](__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["access"]);
