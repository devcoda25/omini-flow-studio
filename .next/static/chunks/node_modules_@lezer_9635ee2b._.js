...
*/ class Tree {
    ...
    */ cursorAt(pos) {
        let side = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, mode = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0;
    ...
    */ resolve(pos) {
        let side = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
...
class BaseNode {
    ...
    getChild(type) {
        let before = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null, after = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null;
...
class TreeNode extends BaseNode {
    ...
    nextChild(i, dir, pos, side) {
        let mode = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : 0;
        for(let parent = this;;){
    ...
    enter(pos, side) {
        let mode = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0;
        let mounted;
...
function matchNodeContext(node, context) {
    let i = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : context.length - 1;
...
*/ class TreeCursor {
    ...
    */ childBefore(pos) {
    ...
    set to false.
    */ enter(pos, side) {
        let mode = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : this.mode;
    ...
    */ next() {
        let enter = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true;
...
*/ class TreeFragment {
    ...
    */ get openEnd() {
    ...
    true.
    */ static addTree(tree) {
        let fragments = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [], partial = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
        let result = [
    ...
    */ static applyChanges(fragments, changes) {
        let minGap = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 128;
...
*/ class Tag {
    toString() {
        let { name } = this;
        for (let mod of this.modified)if (mod.name) name = "".concat(mod.name, "(").concat(name, ")");
        return name;
    }
...
*/ from = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 0, /**
...
break.
*/ function highlightCode(code, tree, highlighter, putText, putBreak) {
    let from = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : 0, to = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : code.length;
    let pos = from;
...
*/ class Stack {
    ...
    */ storeNode(term, start, end) {
        let size = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 4, mustSink = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : false;
...
class StackBufferCursor {
    static create(stack) {
        let pos = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : stack.bufferBase + stack.buffer.length;
...
function decodeArray(input) {
    let Type = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Uint16Array;
...
*/ class InputStream {
    ...
    */ acceptToken(token) {
        let endOffset = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
...
*/ class LRParser extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$lezer$2f$common$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Parser"] {
    ...
    */ getGoto(state, term) {
        let loose = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
        let table = this.goto;
...
"[project]/node_modules/@lezer/json/dist/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const jsonHighlighting = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$lezer$2f$highlight$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["styleTags"])({
    ...
    "True False": __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$lezer$2f$highlight$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tags"].bool,
...
//# sourceMappingURL=node_modules_%40lezer_9635ee2b._.js.map